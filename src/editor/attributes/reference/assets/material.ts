...
<li><b>Max</b> (<code>pc.BLEND_MAX</code>): Result is the maximum of source and destination colors.</li>
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            'The strength of the applied normal map. This is a value between 0 (the normal map has no effect) and 2 (the effect of the normal map is exaggerated). It defaults to 1.',
    ...
    },
    {
        ...
        subTitle: '{pc.Texture}',
        description:
            'A cube map texture asset that approximates environment reflection (with greater accuracy than is possible with a sphere map). If scene has SkyBox set, then it will be used as default cubeMap',
...
<li><b>Front Faces</b> (<code>pc.CULLFACE_FRONT</code>): Front faces are culled.</li>
    ...
    },
    {
        ...
        subTitle: '{Boolean}',
        description:
            'If checked, when a mesh with the material is rendered, its depth information is written to the depth buffer. This ensures that when subsequent meshes are rendered, they can be successfully depth tested against meshes rendered with this material. Defaults to on.'
    },
    {
    ...
    },
    {
        ...
        subTitle: '{pc.Texture}',
        description:
            'The diffuse map that specifies the per-pixel diffuse material color. If no diffuse map is set, the diffuse color is used instead.',
    ...
    },
    {
        ...
        subTitle: '{pc.Texture}',
        description:
            'The emissive map that specifies the per-pixel emissive color. If no emissive map is set, the emissive color is used instead.',
    ...
    },
    {
        ...
        subTitle: '{pc.Texture}',
        description:
            'The gloss map that specifies a per-pixel shininess value. The gloss map is modulated by the shininess property.',
    ...
    },
    {
        ...
        subTitle: '{pc.Texture}',
        description:
            'The height map that specifies the per-pixel strength of the parallax effect. White is full height and black is zero height.',
    ...
    },
    {
        ...
        subTitle: '{pc.Texture}',
        description:
            'The lightmap texture that contains pre-baked diffuse lighting. The lightmap usually is applied to the second UV set.',
    ...
    },
    {
        ...
        subTitle: '{pc.Texture}',
        description:
            'This map specifies per-pixel metalness values. A value of 1 is metal and a value of 0 is non-metal.',
    ...
    },
    {
        ...
        subTitle: '{pc.Texture}',
        description:
            "The normal map that specifies the per-pixel surface normals. The normal map is modulated by the 'Bumpiness' property.",
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            'The opacity of the material. This is a value between 0 (completely transparent) and 1 (completely opaque. It defaults to 1.',
    ...
    },
    {
        ...
        subTitle: '{pc.Texture}',
        description:
            "The opacity map that specifies the per-pixel opacity. The opacity map is modulated by the 'Amount' property.",
    ...
    },
    {
        ...
        description:
            'A height map gives further realism to a normal map by giving the illusion of depth to a surface. Note that parallax options are only enabled if you have set a normal map on the material.',
        url: 'https://api.playcanvas.com/engine/classes/StandardMaterial.html'
    },
    {
        ...
        subTitle: '{Number}',
        description:
            'A factor to determine what portion of light is reflected from the material. This value defaults to 1 (full reflectivity).',
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            'A value determining the smoothness of a surface. For smaller shininess values, a surface is rougher and specular highlights will be broader. For larger shininess values, a surface is smoother and will exhibit more concentrated specular highlights (as is the surace is polished and shiny).',
    ...
    },
    {
        ...
        subTitle: '{pc.Texture}',
        description:
            'The specular map that specifies the per-pixel specular color. If no specular map is set, the specular color is used instead.',
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            'If no specularity factor map is set or tint is checked, this is the specular factor of the material.',
    ...
    },
    {
        ...
        subTitle: '{pc.Texture}',
        description:
            'The specularity factor map that specifies the per-pixel specular color. If no specular map is set, the specular color is used instead.',
    ...
    },
    {
        ...
        subTitle: '{String}',
        description:
            'An specularity factor map color channel to extract color value from texture. Can be: r, g, b, a, rgb',
    ...
    },
    {
        ...
        subTitle: '{Boolean}',
        description:
            "Check this to modulate the material's specularity factor map with a material specific specular color.",
    ...
    },
    {
        ...
        subTitle: '{pc.Texture}',
        description:
            'A sphere map texture asset that approximates environment reflection. If a sphere map is set, the Cube Map property will be hidden (since these properties are mutually exclusive).',
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            'A value determining the smoothness of a surface. For smaller glossiness values, the clear coat surface is rougher and specular highlights will be broader. For larger glossiness values, the clear coat surface is smoother and will exhibit more concentrated specular highlights (as if the clear coat surface is polished and shiny).',
    ...
    },
    {
        ...
        subTitle: '{pc.Texture}',
        description:
            'The clear coat gloss map that specifies a per-pixel intensity value. The clear coat gloss map is modulated by the clearCoat property.',
    ...
    },
    {
        ...
        subTitle: '{pc.Texture}',
        description:
            'The sheen map that specifies the per-pixel sheen specular color. If no sheen map is set, the sheen color is used instead.',
    ...
    },
    {
        ...
        subTitle: '{pc.Texture}',
        description:
            'The sheen gloss map that specifies the per-pixel sheen gloss color. If no sheen gloss map is set, the sheen gloss is used instead.',
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            'Determines the amount of distortion of light passing through the material. Represented as 1.0 / Index of Refraction',
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            'The thickness scale of the material. When used with thickness map, this value scales the thickness of the medium using the map as a weight. The units are in whatever unit the object is in.',
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            'The iridescence min thickness of the thin-film layer. Used with iridescence thickness map to scale the value between min and max. The unit is in nanometers (nm)',
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            'The iridescence max thickness of the thin-film layer. If no iridescence thickness map is used, this is the thickness of the thin-film layer. The unit is in nanometers (nm)',
    ...
    },
    {
        ...
        subTitle: '{String}',
        description:
            'Used to specify whether shadow opacity is dithered, which allows shadow transparency without alpha blending',
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            'Use alphaFade to fade out materials that do not use opacity to fade specular (opacityFadesSpecular is false).',
    ...
    },
    {
        ...
        subTitle: '{Boolean}',
        description:
            'Calculate proper normals on the backface. When cull mode is set to None, this enables lighting to be calculated for the backside of the mesh.',
