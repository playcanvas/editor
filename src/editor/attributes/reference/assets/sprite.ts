...
export const fields: AttributeReference[] = [
    {
        ...
        subTitle: '{Class}',
        description:
            'A Sprite Asset can contain one or multiple Frames from a Texture Atlas Asset. It can be used by the Sprite Component or the Element component to render those frames. You can also implement sprite animations by adding multiple Frames to a Sprite Asset.',
