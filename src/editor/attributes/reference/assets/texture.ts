...
export const fields: AttributeReference[] = [
    {
        ...
        subTitle: '{Class}',
        description:
            'Textures assets are image files which are used as part of a material to give a 3D model a realistic appearance.',
...
<li><b>Mirror Repeat</b> (<code>pc.ADDRESS_MIRRORED_REPEAT</code>): Texture tiles with alternating mirroring.</li>
    ...
    },
    {
        ...
        title: 'interlaced',
        description:
            'If picture is Interlaced. This picture (PNG, JPG) format feature is unavailable for WebGL but is available for use in DOM, making pictures to appear before fully loaded, and load progressively.'
    },
    {
        name: 'asset:texture:rgbm',
        title: 'rgbm',
        description:
            'Specifies whether the texture contains RGBM-encoded HDR data. Mutually exclusive with sRGB. Defaults to false.'
    },
    {
        name: 'asset:texture:srgb',
        title: 'srgb',
        description:
            'Specifies whether the texture is sRGB (standard RGB) or not. Texture representing colors (albedo, emissive, specular, sheen) should have this enabled, while other textures (normal, roughness, occlusion, ...) should be this disabled. Mutually exclusive with RGBM. Defaults to true.'
    },
    {
...
<li><b>Linear</b> (<code>pc.FILTER_LINEAR</code>): Bilinear filtering, smooth interpolation between pixels.</li>
    ...
    },
    {
        ...
        title: 'Compression',
        description:
            'Compressed textures load faster and consume much less VRAM on GPU allowing texture intense applications to have bigger scale.'
    },
    {
