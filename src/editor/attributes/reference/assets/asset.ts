...
editor.once('load', () => {
    const fields: AttributeReference[] = [
        ...
        },
        {
            ...
            subTitle: '{String}',
            description:
                'The type of the asset. One of: animation, audio, image, json, material, model, text, texture.',
            url: 'https://api.playcanvas.com/engine/classes/Asset.html#type'
        },
        {
            name: 'asset:size',
            description:
                'Size of an asset. Keeping this value as tiny as possible will lead to faster application loading and less bandwidth required to launch the app.'
        },
        {
            name: 'asset:source',
        ...
        },
        {
            ...
            subTitle: '{pc.Tags}',
            description:
                'Interface for tagging assets. Allows to find assets by tags using app.assets.findByTag method.',
        ...
        },
        {
            name: 'asset:bundles',
            description:
                'If the asset is included in any Asset Bundles then these are listed here. You can also add the asset to an Asset Bundle by using the dropdown.'
        },
        {
            name: 'asset:localization',
            title: 'LOCALIZATION',
            description:
                "Here you can define a replacement asset to be used for a particular locale. When the application's locale changes then references to this asset will use the replacement asset for the new locale."
        },
        ...anim,
        ...animation,
        ...audio,
