...
export const fields: AttributeReference[] = [
    ...
    },
    {
        ...
        description:
            'Generate the prefiltered lighting data in cubemap format instead of atlas format. This option will result in larger prefiltered data that is slower to download at runtime, but is kept for backwards compatibility.'
    }
];
