...
editor.once('load', () => {
    const fields: AttributeReference[] = [
        ...
        },
        {
            ...
            description:
                'Version control preferences that affect only you, such as automatically loading checkpoint diffs.'
        },
        {
            name: 'settings:snap',
            description:
                'Set the increment for gizmo snapping. Hold Shift or use the Snap toggle on the toolbar to enable snapping while using gizmos.'
        },
        {
            name: 'settings:grid',
            description:
                'To disable the grid, set Divisions to 0. Divisions specifies the number of grid cells in each horizontal direction. Size specifies the size of a cell.'
        },
        {
            name: 'settings:cameraClip',
            description:
                'If your scene is very large or objects need to be very close, adjust the editor camera Near/Far clip values. This setting does not affect the game.'
        },
        {
            name: 'settings:cameraGrabDepth',
            description:
                'Enable generating a depth map texture for the editor viewport. Required to preview certain material effects.'
        },
        {
            name: 'settings:cameraGrabColor',
            description:
                'Enable generating a color map texture for the editor viewport. Required to preview certain material effects.'
        },
        {
...
<li><b>Classic</b>: Legacy gizmo style matching the original PlayCanvas Editor.</li>
        ...
        },
        {
            ...
            description:
                'The locale to preview in the editor and when you launch the application. This is only visible to you, not to other team members.'
        },
        {
        ...
        },
        {
            ...
            description:
                "When enabled, duplicated entities are renamed by appending an incrementing number to ensure uniqueness. For example, 'Box' becomes 'Box2'."
        },
        {
        ...
        },
        {
            ...
            description:
                'Automatically compute and show diffs in the Version Control panel. Turn off on very large projects where diff generation is slow.'
        },
        {
...
<li><b>Dome</b>: Skybox is mapped to a hemispherical dome mesh.</li>
        ...
        },
        {
            ...
            subTitle: '{Number}',
            description:
                'Mip level of the prefiltered skybox. Higher values select lower-resolution, more prefiltered (blurred) mips.',
        ...
        },
        {
            ...
            subTitle: '{Boolean}',
            description:
                'Whether the sky writes to the depth buffer. Disable to allow 3D geometry to render on top of the sky.',
...
<li><b>Exponential Squared</b> (<code>pc.FOG_EXP2</code>): Fog fades in with exponential squared falloff.</li>
        ...
        },
        {
            ...
            subTitle: '{Number}',
            description:
                'The distances, in scene units, from the viewpoint where fog starts to fade in (start) and where it reaches maximum (end). Objects beyond the maximum distance are rendered with the fog color.',
        ...
        },
        {
            ...
            description:
                "The name of the script to use for creating the application's loading screen. The script must call pc.script.createLoadingScreen.",
        ...
        },
        {
            ...
            title: 'External Scripts',
            description:
                'The URLs of external scripts you would like to include in your application. These URLs are added as <script> tags in the main HTML page of the application before any other script is loaded.'
        },
        {
...
<li><b>Fixed</b> (<code>pc.RESOLUTION_FIXED</code>): Canvas resolution stays fixed at the specified width and height.</li>
        ...
        },
        {
            ...
            description:
                'When enabled, the canvas back buffer resolution is multiplied by the device pixel ratio (e.g., 2x on Retina). This increases sharpness on high‑DPI displays but also increases GPU workload and memory usage.'
        },
        {
...
<li><b>High Performance</b>: Prioritize rendering performance (e.g., discrete GPU).</li>
        ...
        },
        {
            ...
            description:
                'Makes the canvas background transparent so the web page (e.g., CSS backgrounds and DOM content) shows through. Useful for overlaying the app on custom page designs or UI.'
        },
        {
            name: 'settings:project:preserveDrawingBuffer',
            title: 'Preserve drawing buffer',
            description:
                "When enabled, the drawing buffer is preserved until it's explicitly cleared. Useful for taking screenshots."
        },
        {
            name: 'settings:input',
            title: 'Input',
        ...
        },
        {
            ...
            description:
                'If enabled, imported textures are converted to Texture Atlas assets instead of Texture assets.'
        },
        {
            name: 'settings:asset-import:searchRelatedAssets',
            title: 'Search related assets',
            description:
                'If enabled, importing a source asset updates related target assets wherever they are located. If disabled, assets are updated only when in the same folder; otherwise, new assets are created.'
        },
        {
            name: 'settings:asset-import:preserveMapping',
            title: 'Preserve model material mappings',
            description:
                'If enabled, when reimporting an existing source model, the Editor attempts to preserve existing user-defined material mappings.'
        },
        {
        ...
        },
        {
            ...
            description:
                'Generates a template asset when importing 3D assets (FBX, etc.). The template asset contains the full entity hierarchy from the imported file.'
        },
        {
...
<li><b>Draco</b>: Compress meshes using Google Draco for smaller file sizes.</li>
        ...
        },
        {
            ...
            description:
                'Specify the speed of mesh decoding. A lower value results in slower decoding but smaller file sizes.'
        },
        {
            name: 'settings:asset-import:dracoMeshSize',
            title: 'Draco Mesh Size',
            description:
                'Specify the size factor used when compressing mesh attributes. A lower value uses fewer bits to compress attributes, resulting in a smaller file but less detail and potential artifacts.'
        },
        {
            name: 'settings:asset-import:createFBXFolder',
            title: 'Create FBX Folder',
            description:
                'Creates a new folder in the current directory when importing an FBX file to store the imported FBX contents.'
        },
        {
            name: 'settings:asset-import:animSampleRate',
            title: 'Animation Sample Rate',
            description:
                'The rate at which to sample animation curves (samples per second). Specify 0 to disable sampling and use input keys instead.'
        },
        {
            name: 'settings:asset-import:animCurveTolerance',
            title: 'Animation Curve Tolerance',
            description:
                'The tolerance used when optimizing linear animation curve segments. Specify 0 to disable curve optimization.'
        },
        {
            name: 'settings:asset-import:animEnableCubic',
            title: 'Animation Cubic Curves',
            description:
                'Output cubic curves when they are encountered. Disable to convert all curves to linear segments.'
        },
        {
...
<li><b>Use FBX Filename</b>: Name animations after the source FBX filename.</li>
        ...
        },
        {
            ...
            description:
                'Imports morph target normals when importing a model. Disable this if morph target normals look incorrect.'
        },
        {
            name: 'settings:asset-import:useUniqueIndices',
            title: 'Use Unique Indices',
            description:
                'Use vertex attribute indices to resolve uniqueness when importing FBX models. Otherwise use vertex attributes to resolve uniqueness. Enabling this option will generally result in more vertices being generated, but their order will be preserved.'
        },
        {
            name: 'settings:asset-import:defaultAssetPreload',
            title: 'Preload new assets',
            description:
                'Creates new assets with the preload option enabled. Script assets are always created with preload enabled.'
        },
        {
        ...
        },
        {
            ...
            subTitle: '{Number}',
            description:
                'The resolution of auto-generated lightmap textures is based on the area of geometry in world space and the size multipliers of the model and scene. Changing this value affects lightmap resolution across the whole scene.',
...
<li><b>Shadow Map PCF 5x5</b>: Percentage-closer filtering with 5x5 kernel for smoother shadows.</li>
        ...
        },
        {
            ...
            title: 'Batch Groups',
            description:
                'Manage batch groups for this project. Batch groups reduce draw calls by batching similar models and elements together.'
        },
        {
        ...
        },
        {
            ...
            subTitle: '{Boolean}',
            description:
                'Enable to allow objects in this batch group to move, rotate, or scale after being batched. If your objects are completely static, disable this setting.'
        },
        {
            ...
            subTitle: '{Number}',
            description:
                'The maximum size of any dimension of a bounding box around batched objects. A larger size batches more objects, generating fewer draw calls, but creates larger batched objects that are harder to cull. A smaller size generates more draw calls (but fewer than without batching) while producing smaller batched objects that are easier to cull.'
        },
        {
        ...
        },
        {
            ...
            title: 'Opaque Part',
            description:
                'This is the part of the layer that renders the opaque mesh instances that belong to this layer.'
        },
        {
            name: 'settings:layers:sublayers:transparent',
            title: 'Transparent Part',
            description:
                'This is the part of the layer that renders the semi-transparent mesh instances that belong to this layer.'
        },
        {
            name: 'settings:layers:sublayers:enabled',
            title: 'Enabled',
            description:
                'Enables or disables this part of the layer. When a part is disabled, the mesh instances of that part will not be rendered.'
        },
        {
        ...
        },
        {
            ...
            description:
                'JSON assets that contain localization data. Assets in this list are automatically parsed for localization data when loaded. These are used to localize your text elements.'
        },
        {
