...
export const fields: AttributeReference[] = [
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            "Controls the amount of energy lost when two rigid bodies collide. The restitution of two colliding bodies are multiplied together and this value is then used to scale each body's velocity. So if restitution for both bodies is 1, no energy is lost. If one body has a restitution of 0, both bodies will lose all energy. You can informally think of restitution as a measure of how bouncy a body is.",
...
<li><b>Kinematic</b> (<code>pc.BODYTYPE_KINEMATIC</code>): Controlled by code. Not affected by physics but can push dynamic bodies.</li>
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            'Sets a torsional friction orthogonal to the contact point. This prevents round objects (spheres, cylinders) from rolling indefinitely.',
