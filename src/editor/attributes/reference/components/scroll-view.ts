...
<li><b>Infinite</b> (<code>pc.SCROLL_MODE_INFINITE</code>): Content can be scrolled indefinitely.</li>
    ...
    },
    {
        ...
        subTitle: '{Boolean}',
        description:
            'Whether to use mouse wheel for scrolling (horizontally and vertically) when mouse is within bounds.',
    ...
    },
    {
        ...
        subTitle: '{pc.Vec2}',
        description:
            "Mouse wheel horizontal and vertical sensitivity. Only used if 'Use Mouse Wheel' is set. Setting a direction to 0 will disable mouse wheel scrolling in that direction. 1 is a default sensitivity that is considered to feel good. The values can be set higher or lower than 1 to tune the sensitivity. Defaults to [1, 1].",
