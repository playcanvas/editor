...
export const fields: AttributeReference[] = [
    {
        ...
        description:
            'A ScrollbarComponent enables a group of entities to behave like a scrollbar, with different visual states for hover and press interactions.',
...
<li><b>Vertical</b> (<code>pc.ORIENTATION_VERTICAL</code>): Scrollbar moves up/down.</li>
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            'The size of the handle relative to the size of the track, in the range 0...1. For a vertical scrollbar, a value of 1 means that the handle will take up the full height of the track.',
