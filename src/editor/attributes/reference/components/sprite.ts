...
export const fields: AttributeReference[] = [
    {
        ...
        description:
            'The Sprite Component enables an Entity to render a simple static Sprite or Sprite Animation Clips.',
...
<li><b>Animated</b> (<code>pc.SPRITETYPE_ANIMATED</code>): Can play Sprite Animation Clips.</li>
    ...
    },
    {
        ...
        description:
            'The width and height of the Sprite when rendering using 9-Slicing. The width and height are only used when the render mode of the Sprite Asset is Sliced or Tiled.',
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            'The width of the Sprite when rendering using 9-Slicing. The width is only used when the render mode of the Sprite Asset is Sliced or Tiled.',
        url: 'https://api.playcanvas.com/engine/classes/SpriteComponent.html#width'
    },
    {
        name: 'sprite:height',
        ...
        subTitle: '{Number}',
        description:
            'The height of the Sprite when rendering using 9-Slicing. The height is only used when the render mode of the Sprite Asset is Sliced or Tiled.',
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            'The draw order of the sprite. A higher value means that the component will be rendered on top of other components in the same layer. For this work the sprite must be in a layer that uses Manual sort order.',
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            'The batch group that this sprite belongs to. The engine will attempt to batch sprites in the same batch group to reduce draw calls.',
    ...
    },
    {
        ...
        subTitle: '{Number[]}',
        description:
            'The layers that this sprite belongs to. When a sprite belongs to multiple layers it will be rendered multiple times.',
