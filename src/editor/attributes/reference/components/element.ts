...
<li><b>Group</b> (<code>pc.ELEMENTTYPE_GROUP</code>): A container for other elements. Does not render anything itself.</li>
    ...
    },
    {
        ...
        subTitle: '{pc.Vec4}',
        description:
            'The left, bottom, right and top anchors of the Element. These range from 0 to 1. If the horizontal or vertical anchors are split (not equal) then the Element will grow to fill the difference.',
    ...
    },
    {
        ...
        title: 'Localized',
        description:
            "Enable this to set the localization key of the Element. The localization key will be used to get the translation of the element's text at runtime."
    },
    {
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            'The number of pixels that correspond to one PlayCanvas unit. Used when using 9 Sliced Sprite Assets to control the thickness of the borders. If this value is not specified the Element component will use the pixelsPerUnit value from the Sprite Asset.',
    ...
    },
    {
        ...
        subTitle: '{String}',
        description:
            "Set how the content should be fitted and preserve the aspect ratio of the source texture or sprite. Use 'Stretch' to always stretch the content to fit the entire Element; Use 'Contain' to resize the content to fit within this Element's bounding box; Use 'Cover' to cover the entire Element's bounding box.",
    ...
    },
    {
        ...
        subTitle: '{Boolean}',
        description:
            "If enabled then the font size of the Element will scale automatically so that it fits the Element's height. The value of this field will be ignored if autoHeight is enabled. The font size will scale between the values of minFontSize and fontSize. The lineHeight will scale proportionately.",
    ...
    },
    {
        ...
        description:
            'The width and height of the Element. You can only edit the width or the height if the corresponding anchors of the Element are not split.',
    ...
    },
    {
        ...
        title: 'width',
        description:
            'The width of the Element. You can only edit the width if the corresponding anchors of the Element are not split.',
        url: 'https://api.playcanvas.com/engine/classes/ElementComponent.html#width'
    },
    {
        name: 'element:height',
        title: 'height',
        description:
            'The height of the Element. You can only edit the height if the corresponding anchors of the Element are not split.',
    ...
    },
    {
        ...
        description:
            'Controls the spacing between each edge of the Element and the respective anchor. You can only edit the margin if the related anchors are split.',
    ...
    },
    {
        ...
        subTitle: '{pc.Vec4}',
        description:
            'The u, v, width and height of the rectangle that represents the portion of the texture that this image maps to.',
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            'The size of the font used by the Element. When autoFitWidth or autoFitHeight are true then it scales between minFontSize and maxFontSize depending on the size of the Element.',
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            'The height of each line of text. If autoFitWidth or autoFitHeight are enabled then the lineHeight will scale with the font.',
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            'The maximum number of lines that this Element can display. Any left-over text will be appended to the last line of the Element. You can delete this value if you wish to have unlimited lines.',
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            'The batch group that this Element belongs to. The engine will attempt to batch Elements in the same batch group to reduce draw calls.',
    ...
    },
    {
        ...
        subTitle: '{Number[]}',
        description:
            'The layers that this Element belongs to. When an Element belongs to multiple layers it will be rendered multiple times.',
    ...
    },
    {
        ...
        subTitle: '{pc.Vec2}',
        description:
            'Controls the horizontal and vertical shift of the text shadow cast effect. The rage of both components is form -1 to 1. To disable effect set both to 0.',
