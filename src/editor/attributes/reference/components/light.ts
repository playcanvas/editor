...
<li><b>Inverse Squared</b> (<code>pc.LIGHTFALLOFF_INVERSESQUARED</code>): Physically accurate falloff where intensity decreases with the square of distance.</li>
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            "The half-angle (measured in degrees from the light's direction axis to the cone edge) at which the spotlight cone starts to fade off. The full inner beam angle is twice this value. Affects spot lights only.",
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            "Constant depth offset applied to a shadow map that enables the tuning of shadows in order to eliminate rendering artifacts, namely 'shadow acne' and 'peter-panning'.",
...
<li><b>Spot</b> (<code>"spot"</code>): Emits light in a cone shape, like a flashlight or stage light.</li>
    ...
    },
    {
        ...
        subTitle: '{Boolean}',
        description:
            'If enabled the material specularity will be affected by this light. Affects directional lights only.',
    ...
    },
    {
        ...
        subTitle: '{pc.Asset}',
        description:
            'Projection texture asset. Spot lights require a texture asset, omni lights require a cubemap asset.',
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            'The size of the penumbra for PCSS (Percentage Closer Soft Shadows). A larger value produces softer shadow edges. Only applies when shadows are enabled.',
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            'The falloff rate for shadow penumbra for PCSS (Percentage Closer Soft Shadows). Controls how quickly the shadow edge transitions from hard to soft. Only applies when shadow type is PCSS.',
