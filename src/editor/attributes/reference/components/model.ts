...
export const fields: AttributeReference[] = [
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            'The model asset rendered by this model component. Only a single model can be rendered per model component.',
    ...
    },
    {
        ...
        subTitle: '{Boolean}',
        description:
            'If enabled, the model rendered by this component will cast shadows onto other models in the scene.',
    ...
    },
    {
        ...
        subTitle: '{Boolean}',
        description:
            'If enabled, the model rendered by this component will receive shadows cast by other models in the scene.',
...
<li><b>Plane</b> (<code>"plane"</code>): Render a procedural plane primitive.</li>
    ...
    },
    {
        ...
        subTitle: '{Number}',
        description:
            'The batch group that this model belongs to. The engine will attempt to batch models in the same batch group to reduce draw calls.',
        url: 'https://api.playcanvas.com/engine/classes/ModelComponent.html#batchgroupid'
    },
    {
        name: 'model:resolution',
        description:
            'Auto-generated lightmap textures resolution is calculated using area of geometry in world space and size multiplier of model and scene.',
    ...
    },
    {
        ...
        subTitle: '{Number[]}',
        description:
            'The layers that this model belongs to. When a model belongs to multiple layers it will be rendered multiple times.',
    ...
    },
    {
        ...
        title: 'Custom AABB',
        description:
            'If true, then a user provided bounding box will be used for visibility culling of attached mesh instances. This is an optimization allowing an oversized bounding box to be specified for skinned characters in order to avoid per frame bounding box computations based on bone positions.'
    },
    {
