...
export const fields: AttributeReference[] = [
    {
        ...
        description:
            'Enables an Entity to render a mesh or a primitive shape. This component attaches geometry to the Entity.',
...
<ul>
<li><b>Asset</b> (<code>"asset"</code>): Render a mesh from a render asset.</li>
