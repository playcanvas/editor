...
export const fields: AttributeReference[] = [
    {
        ...
        description:
            'Enables an entity to animate its model component using the supplied anim state graph asset and attached animation assets.',
    ...
    },
    {
        ...
        subTitle: '{Boolean}',
        description:
            'If true, the weights of all layers will be normalized together. Otherwise, the animations of each layer will be applied independently.',
