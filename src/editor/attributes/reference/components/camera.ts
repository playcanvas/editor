...
export const fields: AttributeReference[] = [
    ...
    },
    {
        ...
        subTitle: '{Boolean}',
        description:
            'If selected, the camera will explicitly clear its render target to the chosen clear color before rendering the scene.',
    ...
    },
    {
        ...
        subTitle: '{Boolean}',
        description:
            'If selected, the camera will explicitly clear the depth buffer of its render target before rendering the scene.',
    ...
    },
    {
        ...
        subTitle: '{Boolean}',
        description:
            'If selected, the camera will request the scene to generate a texture containing the scene depth map.',
    ...
    },
    {
        ...
        subTitle: '{Boolean}',
        description:
            'If selected, the camera will request the scene to generate a texture containing the scene color map.',
