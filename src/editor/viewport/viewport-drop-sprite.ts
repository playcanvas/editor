...
editor.once('load', () => {
    ...
    editor.call('drop:target', {
        ...
        drop: function (type, data) {
            ...
            let previousSelection = editor.api.globals.selection.items;
            ...
            editor.api.globals.history.add({
                ...
                undo: function () {
                    ...
                    editor.api.globals.selection.set(previousSelection, { history: false });
                },
                redo: function () {
                    if (!parent) {
                        return;
                    ...
                    previousSelection = editor.api.globals.selection.items;
                    editor.api.globals.selection.set(entities, { history: false });
