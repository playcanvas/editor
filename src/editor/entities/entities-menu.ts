...
editor.once('load', () => {
    ...
    const createButtonEntityData = (additions?) => {
        const data = {
            ...
            postCreationCallback: function (button: Observer) {
    ...
    const createScrollbarEntityData = (orientation, additions) => {
        ...
        const data = {
            ...
            postCreationCallback: function (scrollbar: Observer) {
                    ...
                    },
                    {
                        ...
                        onSelect: () => {
                            ...
                            editor.call('entities:new', {
                                ...
                                postCreationCallback: function (scrollView: Observer) {
                                    const history = scrollView.history.enabled;
                                    scrollView.history.enabled = false;
                                    scrollView.set(
                                        'components.scrollview.viewportEntity',
                                        scrollView.findByName('Viewport').get('resource_id')
                                    );
                                    scrollView.set(
                                        'components.scrollview.contentEntity',
                                        scrollView.findByName('Content').get('resource_id')
                                    );
                                    scrollView.set(
                                        'components.scrollview.verticalScrollbarEntity',
                                        scrollView.findByName('VerticalScrollbar').get('resource_id')
                                    );
                                    scrollView.set(
                                        'components.scrollview.horizontalScrollbarEntity',
                                        scrollView.findByName('HorizontalScrollbar').get('resource_id')
                                    );
