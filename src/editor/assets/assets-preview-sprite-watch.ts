editor.once('load', () => {
    ...
    const subscribe = function (watch) {
        ...
        const watchAtlas = function () {
            ...
            if (atlasAsset) {
                ...
                watch.events.onAtlasRemove = atlasAsset.once('destroy', () => {
        ...
        watch.events.onSetAtlas = watch.asset.on('data.textureAtlasAsset:set', () => {
            unwatchAtlas(watch, currentAtlas);
            watchAtlas();
        });

        watch.events.onSpriteChange = watch.asset.on('*:set', (path) => {
    ...
    editor.method('assets:sprite:watch:trigger', (asset) => {
    ...
    editor.method('assets:sprite:watch', (args) => {
