...
editor.once('load', () => {
    ...
    const bubbleStore = function () {
        const bubble = editor.call(
            'guide:bubble',
            'Store',
            `<img width="424" height="133" src="${config.url.frontend}static/img/asset_library.jpg"/><br/><br/>Click the <strong>STORE</strong> button to open the Store. Add free 3D models and assets from the Store into your scene with a single click.`,
            '95%',
            0,
            'bottom-right',
            editor.call('layout.assets')
