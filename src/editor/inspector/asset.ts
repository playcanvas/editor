...
import { CssAssetInspector } from './assets/css';
import { CubemapAssetInspector } from './assets/cubemap';
import { CubemapAssetInspectorPreview } from './assets/cubemap-preview';
import { FontAssetInspector } from './assets/font';
import { FontAssetInspectorPreview } from './assets/font-preview';
import { FontSourceAssetInspector } from './assets/font-source';
import { GSplatAssetInspector } from './assets/gsplat';
import { HtmlAssetInspector } from './assets/html';
import { JsonAssetInspector } from './assets/json';
import { MaterialAssetInspector } from './assets/material';
import { MaterialAssetInspectorPreview } from './assets/material-preview';
import { ModelAssetInspector } from './assets/model';
import { ModelAssetInspectorPreview } from './assets/model-preview';
import { RenderAssetInspector } from './assets/render';
import { RenderAssetInspectorPreview } from './assets/render-preview';
import { SceneSourceAssetInspector } from './assets/scene-source';
import { ScriptAssetInspector } from './assets/script';
import { ShaderAssetInspector } from './assets/shader';
import { SpriteAssetInspector } from './assets/sprite';
import { SpriteAssetInspectorPreview } from './assets/sprite-preview';
import { TemplateAssetInspectorPreview } from './assets/template-preview';
import { TextAssetInspector } from './assets/text';
import { TextureAssetInspector } from './assets/texture';
import { TextureAssetInspectorPreview } from './assets/texture-preview';
import { TextureSourceAssetInspector } from './assets/texture-source';
