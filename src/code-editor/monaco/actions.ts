editor.once('load', () => {
    ...
    // custom undo
    monacoEditor.addCommand(monaco.KeyMod.CtrlCmd | monaco.KeyCode.KeyZ, () => {
    ...
    // close current file
    monacoEditor.addCommand(monaco.KeyMod.Alt | monaco.KeyCode.KeyW, () => {
        editor.call('editor:command:close');
    });

    // close all files
    monacoEditor.addCommand(monaco.KeyMod.Alt | monaco.KeyMod.Shift | monaco.KeyCode.KeyW, () => {
    ...
    // next tab
    monacoEditor.addCommand(monaco.KeyMod.CtrlCmd | monaco.KeyMod.Alt | monaco.KeyCode.Period, () => {
        editor.call('editor:command:nextTab');
    });

    // previous tab
    monacoEditor.addCommand(monaco.KeyMod.CtrlCmd | monaco.KeyMod.Alt | monaco.KeyCode.Comma, () => {
