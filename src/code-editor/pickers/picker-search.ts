...
editor.once('load', () => {
    ...
    editor.method('picker:search:close', () => {
    ...
    // Return search regex
    editor.method('picker:search:regex', () => {
        return regexp;
    });

    // Set search term externally.
    editor.method('picker:search:set', (text, options) => {
        let dirty = false;
