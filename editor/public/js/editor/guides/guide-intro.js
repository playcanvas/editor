editor.once('load', function () {
    ...
    var bubbleDemo2 = function () {
        var bubble = editor.call(
            ...
            'Hit Ctrl+D or click the <span class="font-pc-icon">&#57638;</span> button to duplicate the selected platform.',
            '50%',
            '50%',
            'left',
            editor.call('layout.viewport')
    ...
    var bubbleDemo4 = function () {
        return editor.call(
            ...
            "Click <span class='font-pc-icon'>&#57649;</span> <strong>Launch</strong> to play the game. Use the arrow keys to move the ball. The game will open in a new tab so just switch back to the Editor tab when you're done.<br/><br/>Any changes you make to the scene will automatically update the launched game.",
            46,
            29,
            'top-right',
    ...
    var bubbleHierarchy = function () {
        return editor.call(
            'guide:bubble',
            'Scene Hierarchy',
            'This is your <strong>Scene Hierarchy</strong> made up of <strong>Entities</strong>, which can be given new behaviours by adding Components.<br/><br/> <span class="font-pc-icon">&#57632;</span> Add, <span class="font-pc-icon">&#57638;</span> Duplicate and <span class="font-pc-icon">&#57637;</span> Delete Entities using the controls in this panel.',
            360,
            60,
            'left'
        );
    ...
    var bubbleLaunch = function () {
        return editor.call(
            'guide:bubble',
            'Launch Preview',
            'Click <span class="font-pc-icon">&#57649;</span> <strong>Launch</strong> to preview your scene. Any changes you make to your scene while in the Editor will automatically update the launched scene.',
            46,
            29,
            'top-right',
            editor.call('layout.toolbar.launch')
    ...
    var bubbleAssets = function () {
        return editor.call(
            'guide:bubble',
            'Assets',
            '<strong>Drag`n`Drop</strong> files from your computer to upload assets or use the <span class="font-pc-icon">&#57632;</span> Add button to create new assets.<br/><br/>You can filter and <span class="font-pc-icon">&#57641;</span> search your assets using the controls at the top.',
            54,
            -39,
            'bottom',
