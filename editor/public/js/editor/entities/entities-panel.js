editor.once('load', function() {
    ...
    if (usePcuiTreeview) {
        treeView = new pcui.EntitiesTreeView({
    ...
    if (!usePcuiTreeview) {
        ...
        var resizeTree = function() {
            ...
            hierarchy.element.style.width = (panel.dom.scrollWidth - 5) + 'px';
        };
    ...
    editor.method('entities:hierarchy', function () {
        return usePcuiTreeview ? treeView : hierarchy;
    });
    ...
    editor.method('entities:panel:get', function (resourceId) {
        return usePcuiTreeview ? treeView.getTreeItemForEntity(resourceId) : uiItemIndex[resourceId];
    });
