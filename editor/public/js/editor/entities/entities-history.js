editor.once('load', function() {
    ...
    editor.on('entities:add', function(entity) {
        ...
        entity.history.on('add', function(data) {
            ...
            if (data.combine && combineFields.indexOf(path) !== -1 && editor.call('history:canUndo') && editor.call('history:current').combine && editor.call('history:current').name === data.name) {
