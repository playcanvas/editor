editor.once('load', function () {
    ...
    editor.call('help:howdoi:register', {
        ...
        text: 'You can delete an Entity by selecting it and pressing <strong>Delete</strong>. Alternatively you can click on the <span class="font-icon">&#58657;</span> Delete button in the Hierarchy panel or right click on the Entity and select Delete from the context menu.',
    ...
    editor.call('help:howdoi:register', {
        ...
        text: 'You can create a light by adding a <strong>Light</strong> component to an Entity. You can also right click on an Entity and select New Entity / Directional Light to create a new directional light and similarly for spot lights and point lights.',
