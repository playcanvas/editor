...
var start = function(id, filename, padding) {
    loadFile(id, filename, function(err, data) {
        if (err) {
            ...
            var multiArea = unwrap.calculateMultiAreaOfJsonModel(data);
            var uv1Area = unwrap.calculateUv1AreaOfJsonModel(data);
...
1]=e:d.push(e))}for(b=a=0;b<d.length;b++)d[b]=(d[b]-3*a)/3,a+=d[b];return d},triangleArea:function(a,b,c,f,d,e,g,k,h){f-=a;d-=b;e-=c;g-=a;k-=b;h-=c;a=d*h-e*k;e=e*g-f*h;f=f*k-d*g;return.5*Math.sqrt(a*a+e*e+f*f)},calculateChartArea:function(a,b,c,f){var d,e,g,k,h,l,r,v,p,m,q,t,n,x,w,u=0,A,B,E=[],F=[],H=0,I=0,y,z,C,D,G=[];for(d=0;d<b.length;d++){g=b[d];B=A=0;y=z=99999;C=D=-99999;for(e=0;e<g;e++)k=u+e,h=a[3*k],l=a[3*k+1],k=a[3*k+2],r=c[3*h],v=c[3*h+1],p=c[3*h+2],m=c[3*l],q=c[3*l+1],t=c[3*l+2],n=c[3*k],
x=c[3*k+1],w=c[3*k+2],A+=this.triangleArea(r,v,p,m,q,t,n,x,w),r=f[2*h],h=f[2*h+1],v=f[2*l],l=f[2*l+1],p=f[2*k],k=f[2*k+1],B+=this.triangleArea(r,h,0,v,l,0,p,k,0),y=Math.min(y,r),y=Math.min(y,v),y=Math.min(y,p),z=Math.min(z,h),z=Math.min(z,l),z=Math.min(z,k),C=Math.max(C,r),C=Math.max(C,v),C=Math.max(C,p),D=Math.max(D,h),D=Math.max(D,l),D=Math.max(D,k);0===A&&(B=A=.01,C=y+.01,D=z+.01);isNaN(A)&&(B=A=.01,C=y+.01,D=z+.01);0===B&&(B=.01,C=y+.01,D=z+.01);H+=A;E.push(A);u+=g;G[d]={x:0,y:0,z:0,w:0};G[d].x=
...
this.resolution-2*this.padding)/4);if(0>=c||0>=l||1E3<c||1E3<l)return[];var r=new Uint8Array(c*l),v=0;for(h=0;h<d.length&&h!==b;h++)v+=d[h];var p=d[b],m=g[b].x*k,q=g[b].y*k,t=g[b].z*k,n=g[b].w*k,x,w,u;for(h=0;h<p;h++){d=e[3*(v+h)];g=e[3*(v+h)+1];b=e[3*(v+h)+2];x=f[2*d]*k;w=f[2*d+1]*k;var A=f[2*g]*k,B=f[2*g+1]*k,E=f[2*b]*k,F=f[2*b+1]*k;x=(x-m)/t;A=(A-m)/t;E=(E-m)/t;w=(w-q)/n;B=(B-q)/n;F=(F-q)/n;g=b=99999;u=d=-99999;b=Math.min(b,x);b=Math.min(b,A);b=Math.min(b,E);g=Math.min(g,w);g=Math.min(g,B);g=Math.min(g,
F);d=Math.max(d,x);d=Math.max(d,A);d=Math.max(d,E);u=Math.max(u,w);u=Math.max(u,B);u=Math.max(u,F);b*=c;d*=c;g*=l;u*=l;b=Math.floor(b)-this.padding;g=Math.floor(g)-this.padding;d=Math.floor(d)+this.padding;u=Math.floor(u)+this.padding;0>b&&(b=0);b>=c&&(b=c-1);0>g&&(g=0);g>=l&&(g=l-1);0>d&&(d=0);d>=c&&(d=c-1);0>u&&(u=0);u>=l&&(u=l-1);for(w=g;w<=u;w++)for(x=b;x<=d;x++)r[w*c+x]=255}b=Math.max(c,l);f=[r];h=c;d=l;e=[h];k=[d];for(g=0;8<b;){p=Math.floor(h/2);m=Math.floor(d/2);v=new Uint8Array(p*m);for(w=
0;w<m;w++)for(x=0;x<p;x++){for(n=b=0;2>n;n++)for(t=0;2>t;t++)b=Math.max(b,f[g][(2*w+n)*h+(2*x+t)]);v[w*p+x]=b}b=Math.max(p,m);h=p;d=m;g++;f[g]=v;e[g]=p;k[g]=m}q=[];for(h=f.length-1;0<=h;h--)for(p=e[h],m=k[h],v=f[h],A=c/p,B=l/m,w=0;w<m;w++)for(x=0;x<p;x++)if(0===v[w*p+x]){g=Math.floor(x*A);u=Math.floor(w*B);d=b=g;g=u;for(var E=b,F=g,H=d,I=u,y=!0,z=0,C=!0;y;){if(0>b||0>g||d>c-1||u>l-1)y=!1;else for(n=g;n<=u;n++){for(t=b;t<=d;t++)if(0<r[n*c+t]){y=!1;break}if(!y)break}if(y)for(t=0;t<q.length;t++)if(!(q[t].maxx<
...
e[b],c[b].w*e[b])-Math.max(c[a].z*e[a],c[a].w*e[a])});for(var v=0,p=0,m=0,q=0,t=99999,n,x=0;x<c.length;x++){k=r[x];n={x:c[k].x,y:c[k].y,z:c[k].z,w:c[k].w};n.x=n.x*e[k]*g;n.y=n.y*e[k]*g;n.z=n.z*e[k]*g;n.w=n.w*e[k]*g;n.z+=2*this.paddingUv;n.w+=2*this.paddingUv;var w=this.insertToAtlas(h,k,n,d,b,a,c,e[k]*g);w?(l[k]=w.aabb,w.insideHole||(p+=l[k].z*l[k].w)):v+=n.z*n.w;m=Math.max(m,n.z);q=Math.max(q,n.w);t=Math.min(t,n.z)}f.usedArea=p;f.maxWidth=m;f.maxHeight=q;f.minWidth=t;if(0<v)return f.notFitted=v,
!1;for(k=0;k<l.length;k++)l[k].z>2*this.paddingUv&&l[k].w>2*this.paddingUv&&(l[k].x+=this.paddingUv,l[k].y+=this.paddingUv,l[k].z-=2*this.paddingUv,l[k].w-=2*this.paddingUv);a=[];for(k=0;k<c.length;k++)n={x:c[k].x,y:c[k].y,z:c[k].z,w:c[k].w},n.x=n.x*e[k]*g,n.y=n.y*e[k]*g,n.z=n.z*e[k]*g,n.w=n.w*e[k]*g,b=l[k].z/n.z,f=l[k].w/n.w,a.push({x:b,y:f,z:l[k].x-n.x*b,w:l[k].y-n.y*f});return{scaleOffset:a,packedAabbs:l}},transformUv2:function(a,b,c,f){a.x=a.x*b*c;a.y=a.y*b*c;return this.transformUv(a,f)},finalTransformUv:function(a,
b,c,f,d,e){var g,k,h,l,r,v={x:0,y:0},p={x:0,y:0},m={x:0,y:0},q=0,t=[];for(g=0;g<b.length;g++){chartTris=b[g];for(k=0;k<chartTris;k++)h=q+k,l=a[3*h],r=a[3*h+1],h=a[3*h+2],v.x=c[2*l],v.y=c[2*l+1],p.x=c[2*r],p.y=c[2*r+1],m.x=c[2*h],m.y=c[2*h+1],t[l]||this.transformUv2(v,f[g],d,e[g]),t[r]||this.transformUv2(p,f[g],d,e[g]),t[h]||this.transformUv2(m,f[g],d,e[g]),c[2*l]=v.x,c[2*l+1]=v.y,c[2*r]=p.x,c[2*r+1]=p.y,c[2*h]=m.x,c[2*h+1]=m.y,t[l]=!0,t[r]=!0,t[h]=!0;q+=chartTris}},totalObjectScale:function(a,b){for(var c=
a.nodes[b].scale,f=c[0],d=c[1],c=c[2],e=a.parents[b],g;0<=e;)g=a.nodes[e].scale,f*=g[0],d*=g[1],c*=g[2],e=a.parents[e];return[f,d,c]},unwrapJsonModel:function(a,b,c,f){this.resolution=1024;this.padding=c;this.paddingUv=this.padding/this.resolution;this.fillHoles=f;var d,e,g,k,h;c=[];var l=[];f=[];var r=[],v=[],p=0,m,q,t,n=[],x=[],w,u;d=.025;h=[];for(d=0;d<a.model.meshInstances.length;d++)if(void 0===h[d])for(h[d]=-1,e=d+1;e<a.model.meshInstances.length;e++)a.model.meshInstances[d].mesh===a.model.meshInstances[e].mesh&&
...
t[u].data,B=t[u].components;for(g=0;g<k.length;g++)for(e=0;e<B;e++)A.push(A[k[g]*B+e])}if(n[q])for(w in h)n[q][w]=h[w];else n[q]=h;x[q]=m}for(d=0;d<a.model.vertices.length;d++){t=a.model.vertices[d];k=t.position.data;h=n[d];m=x[d];v[d]=k.length/3;for(e=0;e<k.length/3;e++)l.push(k[3*e]*m[0]),l.push(k[3*e+1]*m[1]),l.push(k[3*e+2]*m[2]);for(e=0;e<h.length;e++)f.push(h[e]);r[d]=p;p+=k.length/3}for(d=0;d<a.model.meshInstances.length;d++)for(h=a.model.meshInstances[d].mesh,q=a.model.meshes[h].vertices,
g=a.model.meshes[h].indices,e=0;e<g.length;e++)c.push(g[e]+r[q]);w=this.findCharts(c);b=this.calculateChartArea(c,w,l,f);l=this.normalizeCharts(c,w,b,f);p=1;if(!this.cancel){u=this.packCharts(c,w,b.aabbs,b,f,l,p);for(this.progress&&this.progress(30);!u;){if(this.cancel)return;p/=1+b.notFitted;u=this.packCharts(c,w,b.aabbs,b,f,l,p)}for(this.progress&&this.progress(50);;){if(this.cancel)return;d=(1-b.usedArea)/5;u=p;p+=d;if(p===u)break;u=this.packCharts(c,w,b.aabbs,b,f,l,p);if(!u)break}this.progress&&
this.progress(90);p-=d;u=this.packCharts(c,w,b.aabbs,b,f,l,p);d=u.scaleOffset;this.finalTransformUv(c,w,f,l,p,d);for(d=0;d<a.model.vertices.length;d++){h=[];for(e=0;e<2*v[d];e++)h.push(f[2*r[d]+e]);t=a.model.vertices[d];t.texCoord1={data:h,components:2,type:"float32"}}this.progress&&this.progress(100);return{packedAabbs:u.packedAabbs,totalArea:b.totalArea}}},calculateAreaOfJsonModel:function(a){var b,c,f,d,e,g,k,h,l,r,v,p,m,q,t=0;for(b=0;b<a.model.meshInstances.length;b++){d=a.model.meshInstances[b].mesh;
e=a.model.meshInstances[b].node;f=a.model.meshes[d].vertices;d=a.model.meshes[d].indices;f=a.model.vertices[f];f=f.position.data;g=this.totalObjectScale(a.model,e);e=new Float32Array(f.length);k=f.length/3;for(c=0;c<k;c++)e[3*c]=f[3*c]*g[0],e[3*c+1]=f[3*c+1]*g[1],e[3*c+2]=f[3*c+2]*g[2];c=d.length/3;for(f=0;f<c;f++)h=d[3*f],l=d[3*f+1],r=d[3*f+2],g=e[3*h],k=e[3*h+1],h=e[3*h+2],v=e[3*l],p=e[3*l+1],l=e[3*l+2],m=e[3*r],q=e[3*r+1],r=e[3*r+2],t+=this.triangleArea(g,k,h,v,p,l,m,q,r)}return t},calculateUv1AreaOfJsonModel:function(a){var b,
c,f,d,e,g,k,h,l,r,v,p=0;for(b=0;b<a.model.meshInstances.length;b++)for(f=a.model.meshInstances[b].mesh,c=a.model.meshes[f].vertices,f=a.model.meshes[f].indices,c=a.model.vertices[c],d=c.texCoord1.data,e=f.length/3,c=0;c<e;c++)g=f[3*c],k=f[3*c+1],h=f[3*c+2],l=d[2*g],g=d[2*g+1],r=d[2*k],k=d[2*k+1],v=d[2*h],h=d[2*h+1],p+=this.triangleArea(l,g,0,r,k,0,v,h,0);return p},calculateMultiAreaOfJsonModel:function(a){var b,c,f,d,e,g,k,h,l,r,v,p,m,q,t,n={x:0,y:0,z:0};for(b=0;b<a.model.meshInstances.length;b++){d=
a.model.meshInstances[b].mesh;e=a.model.meshInstances[b].node;f=a.model.meshes[d].vertices;d=a.model.meshes[d].indices;f=a.model.vertices[f];f=f.position.data;g=this.totalObjectScale(a.model,e);e=new Float32Array(f.length);k=f.length/3;for(c=0;c<k;c++)e[3*c]=f[3*c]*g[0],e[3*c+1]=f[3*c+1]*g[1],e[3*c+2]=f[3*c+2]*g[2];c=d.length/3;for(f=0;f<c;f++)h=d[3*f],l=d[3*f+1],r=d[3*f+2],g=e[3*h],k=e[3*h+1],h=e[3*h+2],v=e[3*l],p=e[3*l+1],l=e[3*l+2],m=e[3*r],q=e[3*r+1],t=e[3*r+2],r=this.triNormal(g,k,h,v,p,l,m,
q,t),g=this.triangleArea(g,k,h,v,p,l,m,q,t),0<g&&(n.x+=g*(1-Math.abs(r.x)),n.y+=g*(1-Math.abs(r.y)),n.z+=g*(1-Math.abs(r.z)))}n.x*=.5;n.y*=.5;n.z*=.5;return n}};
