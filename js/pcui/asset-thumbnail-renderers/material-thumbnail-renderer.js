import { ThumbnailRendererUtils } from './thumbnail-renderer-utils.js';
...
class MaterialThumbnailRenderer {
    ...
    render(rotationX = 0, rotationY = 0, model = 'sphere') {
        ...
        const layerComposition = ThumbnailRendererUtils.layerComposition;
        const layer = ThumbnailRendererUtils.layer;
        ...
        const rt = ThumbnailRendererUtils.getRenderTarget(app, width, height);
