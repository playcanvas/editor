    ...
    editor.method('menu:entities:new', function (getParentFn) {
        ...
        return [{
            ...
            items: [{
                ...
                icon: componentsLogos.animatedsprite,
                onSelect: () => {
                    var data = editor.call('components:getDefault', 'sprite');
                    data.type = 'animated';
                    data.clips = {
            ...
            items: [{
                ...
                text: 'Layout Group',
                icon: componentsLogos.layoutgroup,
                onSelect: () => {
                    editor.call('entities:new', {
                        name: 'Layout Group',
                        parent: getParentFn(),
                ...
                text: 'Layout Child',
                icon: componentsLogos.layoutchild,
                onSelect: () => {
                    editor.call('entities:new', {
                        name: 'Layout Child',
                        parent: getParentFn(),
