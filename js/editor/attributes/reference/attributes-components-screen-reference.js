editor.once('load', function () {
    var fields = [{
        ...
        description: '',
        url: 'https://developer.playcanvas.com/api/pc.ScreenComponent.html'
    }, {
        title: 'screenSpace',
        subTitle: '{Boolean}',
        description: 'If true then the screen will display its child Elements in 2D. Set this to false to make this a 3D screen.',
        url: 'https://developer.playcanvas.com/api/pc.ScreenComponent.html#screenSpace'
    }, {
        title: 'resolution',
        subTitle: '{pc.Vec2}',
        description: 'The resolution of the screen.',
        url: 'https://developer.playcanvas.com/api/pc.ScreenComponent.html#resolution'
    }, {
        ...
        url: 'https://developer.playcanvas.com/api/pc.ScreenComponent.html#referenceResolution'
    }, {
        title: 'scaleMode',
        subTitle: '{String}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ScreenComponent.html#scaleMode'
    }, {
        title: 'scaleBlend',
        subTitle: '{Number}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ScreenComponent.html#scaleBlend'
    }, {
        title: 'priority',
        subTitle: '{Number}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ScreenComponent.html#priority'
    }];
