editor.once('load', function () {
    var fields = [{
        ...
        url: 'https://developer.playcanvas.com/api/pc.ModelComponent.html#batchGroupId'
    }, {
        name: 'resolution',
        ...
        url: 'https://developer.playcanvas.com/en/user-manual/graphics/lighting/lightmaps/#lightmap-size-multipliers'
    }, {
        name: 'layers',
        title: 'layers',
        subTitle: '{Number[]}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ModelComponent.html#layers'
    }, {
        name: 'customAabb',
        title: 'Custom AABB',
