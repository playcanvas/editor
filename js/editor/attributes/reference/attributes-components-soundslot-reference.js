editor.once('load', function () {
    var fields = [{
        ...
        url: 'https://developer.playcanvas.com/api/pc.SoundSlot.html'
    }, {
        title: 'name',
        subTitle: '{String}',
        description: 'The name of the slot',
        url: 'https://developer.playcanvas.com/api/pc.SoundSlot.html#name'
    }, {
        title: 'startTime',
        subTitle: '{Number}',
        description: 'The start time from which the sound will start playing.',
        url: 'https://developer.playcanvas.com/api/pc.SoundSlot.html#startTime'
    }, {
        title: 'duration',
        subTitle: '{String}',
        description: 'The duration of the sound that the slot will play starting from startTime.',
        url: 'https://developer.playcanvas.com/api/pc.SoundSlot.html#duration'
    }, {
        title: 'autoPlay',
        subTitle: '{Boolean}',
        description: 'If checked, the slot will be played on load. Otherwise, sound slots will need to be played by scripts.',
        url: 'https://developer.playcanvas.com/api/pc.SoundSlot.html#autoPlay'
    }, {
        title: 'overlap',
        subTitle: '{Boolean}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.SoundSlot.html#overlap'
    }, {
        title: 'asset',
        subTitle: '{Number}',
        description: 'The audio asset that can be played from this sound slot.',
        url: 'https://developer.playcanvas.com/api/pc.SoundSlot.html#asset'
    }, {
        title: 'loop',
        subTitle: '{Boolean}',
        description: 'If checked, the slot will loop playback continuously. Otherwise, it will be played once to completion.',
        url: 'https://developer.playcanvas.com/api/pc.SoundSlot.html#loop'
    }, {
        title: 'pitch',
        subTitle: '{Number}',
