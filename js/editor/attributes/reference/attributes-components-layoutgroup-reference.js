editor.once('load', function () {
    var fields = [{
        ...
        url: 'https://developer.playcanvas.com/api/pc.LayoutGroupComponent.html'
    }, {
        title: 'orientation',
        subTitle: '{pc.ORIENTATION}',
        description: 'Whether the layout should run horizontally or vertically.',
        url: 'https://developer.playcanvas.com/api/pc.LayoutGroupComponent.html#orientation'
    }, {
        title: 'reverseX',
        subTitle: '{Boolean}',
        description: 'Reverses the order of elements on the X axis.',
        url: 'https://developer.playcanvas.com/api/pc.LayoutGroupComponent.html#reverseX'
    }, {
        title: 'reverseY',
        subTitle: '{Boolean}',
        description: 'Reverses the order of elements on the Y axis.',
        url: 'https://developer.playcanvas.com/api/pc.LayoutGroupComponent.html#reverseY'
    }, {
        title: 'alignment',
        subTitle: '{pc.Vec2}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.LayoutGroupComponent.html#alignment'
    }, {
        title: 'padding',
        subTitle: '{pc.Vec4}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.LayoutGroupComponent.html#padding'
    }, {
        title: 'spacing',
        subTitle: '{pc.Vec2}',
        description: 'Spacing to be applied between each child element.',
        url: 'https://developer.playcanvas.com/api/pc.LayoutGroupComponent.html#spacing'
    }, {
        title: 'widthFitting',
        subTitle: '{pc.FITTING}',
        description: 'Fitting logic to be applied when positioning and scaling child elements.',
        url: 'https://developer.playcanvas.com/api/pc.LayoutGroupComponent.html#widthFitting'
    }, {
        title: 'heightFitting',
        subTitle: '{pc.FITTING}',
        description: 'Fitting logic to be applied when positioning and scaling child elements.',
        url: 'https://developer.playcanvas.com/api/pc.LayoutGroupComponent.html#heightFitting'
    }, {
        title: 'wrap',
        subTitle: '{Boolean}',
        description: 'Whether or not to wrap children onto a new row/column when the size of the container is exceeded.',
        url: 'https://developer.playcanvas.com/api/pc.LayoutGroupComponent.html#wrap'
    }];
