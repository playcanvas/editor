editor.once('load', function () {
    var fields = [{
        ...
        url: 'https://developer.playcanvas.com/api/pc.ScrollbarComponent.html'
    }, {
        title: 'orientation',
        subTitle: '{pc.ORIENTATION}',
        description: 'Whether the scrollbar moves horizontally or vertically.',
        url: 'https://developer.playcanvas.com/api/pc.ScrollbarComponent.html#orientation'
    }, {
        title: 'handleEntity',
        subTitle: '{pc.Entity}',
        description: 'The entity to be used as the scrollbar handle. This entity must have a Scrollbar component.',
        url: 'https://developer.playcanvas.com/api/pc.ScrollbarComponent.html#handleEntity'
    }, {
        title: 'value',
        subTitle: '{Number}',
        description: 'The current position value of the scrollbar, in the range 0...1.',
        url: 'https://developer.playcanvas.com/api/pc.ScrollbarComponent.html#value'
    }, {
        title: 'handleSize',
        subTitle: '{Number}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ScrollbarComponent.html#handleSize'
    }];
