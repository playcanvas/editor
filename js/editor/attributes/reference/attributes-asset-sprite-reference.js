editor.once('load', function () {
    var fields = [{
        ...
        url: 'https://developer.playcanvas.com/api/pc.Sprite.html'
    }, {
        title: 'pixelsPerUnit',
        subTitle: '{Number}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.Sprite.html#pixelsPerUnit'
    }, {
        title: 'renderMode',
        subTitle: '{Number}',
        description: 'The render mode of the Sprite Asset. It can be Simple, Sliced or Tiled.',
        url: 'https://developer.playcanvas.com/api/pc.Sprite.html#renderMode'
    }, {
        ...
        url: 'https://developer.playcanvas.com/api/pc.Sprite.html#textureAtlasAsset'
    }];
