editor.once('load', function () {
    var fields = [{
        ...
        url: 'https://developer.playcanvas.com/api/pc.LayoutChildComponent.html'
    }, {
        title: 'minWidth',
        subTitle: '{Number}',
        description: 'The minimum width the element should be rendered at.',
        url: 'https://developer.playcanvas.com/api/pc.LayoutChildComponent.html#minWidth'
    }, {
        title: 'minHeight',
        subTitle: '{Number}',
        description: 'The minimum height the element should be rendered at.',
        url: 'https://developer.playcanvas.com/api/pc.LayoutChildComponent.html#minHeight'
    }, {
        title: 'maxWidth',
        subTitle: '{Number}',
        description: 'The maximum width the element should be rendered at.',
        url: 'https://developer.playcanvas.com/api/pc.LayoutChildComponent.html#maxWidth'
    }, {
        title: 'maxHeight',
        subTitle: '{Number}',
        description: 'The maximum height the element should be rendered at.',
        url: 'https://developer.playcanvas.com/api/pc.LayoutChildComponent.html#maxHeight'
    }, {
        ...
        url: 'https://developer.playcanvas.com/api/pc.LayoutChildComponent.html#fitWidthProportion'
    }, {
        ...
        url: 'https://developer.playcanvas.com/api/pc.LayoutChildComponent.html#fitHeightProportion'
    }, {
        title: 'excludeFromLayout',
        subTitle: '{Boolean}',
        description: 'When enabled, the child will be excluded from all layout calculations.',
        url: 'https://developer.playcanvas.com/api/pc.LayoutChildComponent.html#excludeFromLayout'
    }];
