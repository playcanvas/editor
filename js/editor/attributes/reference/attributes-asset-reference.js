editor.once('load', function () {
    var fields = [{
        ...
        url: 'https://developer.playcanvas.com/api/pc.Asset.html'
    }, {
        title: 'name',
        subTitle: '{String}',
        description: 'The name of the asset.',
        url: 'https://developer.playcanvas.com/api/pc.Asset.html#name'
    }, {
        title: 'type',
        subTitle: '{String}',
        description: 'The type of the asset. One of: animation, audio, image, json, material, model, text, texture.',
        url: 'https://developer.playcanvas.com/api/pc.Asset.html#type'
    }, {
        name: 'size',
        ...
        url: 'https://developer.playcanvas.com/api/pc.Asset.html#tags'
    }, {
        name: 'runtime',
        ...
        url: 'https://developer.playcanvas.com/api/pc.Asset.html#preload'
    }, {
        name: 'source',
