editor.once('load', function () {
    var fields = [{
        ...
        url: 'https://developer.playcanvas.com/api/pc.SpriteComponent.html'
    }, {
        title: 'type',
        subTitle: '{Boolean}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.SpriteComponent.html#type'
    }, {
        title: 'color',
        subTitle: '{pc.Color}',
        description: 'The color tint of the Sprite.',
        url: 'https://developer.playcanvas.com/api/pc.SpriteComponent.html#color'
    }, {
        title: 'opacity',
        subTitle: '{Number}',
        description: 'The opacity of the Sprite.',
        url: 'https://developer.playcanvas.com/api/pc.SpriteComponent.html#opacity'
    }, {
        title: 'spriteAsset',
        subTitle: '{pc.Asset}',
        description: 'The Sprite Asset used by the Sprite Component.',
        url: 'https://developer.playcanvas.com/api/pc.SpriteComponent.html#spriteAsset'
    }, {
        title: 'frame',
        subTitle: '{Number}',
        description: 'The frame of the Sprite Asset that the Sprite Component will render.',
        url: 'https://developer.playcanvas.com/api/pc.SpriteComponent.html#frame'
    }, {
        title: 'flipX',
        subTitle: '{Boolean}',
        description: 'Flips the X axis when rendering a Sprite.',
        url: 'https://developer.playcanvas.com/api/pc.SpriteComponent.html#flipX'
    }, {
        title: 'flipY',
        subTitle: '{Boolean}',
        description: 'Flips the Y axis when rendering a Sprite.',
        url: 'https://developer.playcanvas.com/api/pc.SpriteComponent.html#flipY'
    }, {
        title: 'size',
        ...
        url: 'https://developer.playcanvas.com/api/pc.SpriteComponent.html#width'
    }, {
        title: 'width',
        subTitle: '{Number}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.SpriteComponent.html#height'
    }, {
        title: 'drawOrder',
        subTitle: '{Number}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.SpriteComponent.html#drawOrder'
    }, {
        title: 'speed',
        subTitle: '{Number}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.SpriteComponent.html#autoPlayClip'
    }, {
        title: 'batchGroupId',
        subTitle: '{Number}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.SpriteComponent.html#batchGroupId'
    }, {
        name: 'addClip',
        title: 'Add Clip',
        ...
        url: 'https://developer.playcanvas.com/api/pc.SpriteComponent.html#layers'
    }];
