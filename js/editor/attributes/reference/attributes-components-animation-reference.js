editor.once('load', function () {
    var fields = [{
        ...
        url: 'https://developer.playcanvas.com/api/pc.AnimationComponent.html'
    }, {
        title: 'assets',
        subTitle: '{Number[]}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.AnimationComponent.html#assets'
    }, {
        title: 'speed',
        subTitle: '{Number}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.AnimationComponent.html#speed'
    }, {
        title: 'activate',
        subTitle: '{Boolean}',
        description: 'If checked, the component will start playing the animation on load.',
        url: 'https://developer.playcanvas.com/api/pc.AnimationComponent.html#activate'
    }, {
        title: 'loop',
        subTitle: '{Boolean}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.AnimationComponent.html#loop'
    }];
