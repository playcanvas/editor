editor.once('load', function () {
    var fields = [{
        ...
        url: 'https://developer.playcanvas.com/api/pc.CameraComponent.html'
    }, {
        title: 'clearColor',
        subTitle: '{pc.Color}',
        description: 'The color used to clear the camera\'s render target.',
        url: 'https://developer.playcanvas.com/api/pc.CameraComponent.html#clearColor'
    }, {
        ...
        url: 'https://developer.playcanvas.com/api/pc.CameraComponent.html#clearColorBuffer'
    }, {
        ...
        url: 'https://developer.playcanvas.com/api/pc.CameraComponent.html#clearDepthBuffer'
    }, {
        ...
        url: 'https://developer.playcanvas.com/api/pc.CameraComponent.html#requestSceneDepthMap'
    }, {
        ...
        url: 'https://developer.playcanvas.com/api/pc.CameraComponent.html#requestSceneColorMap'
    }, {
        name: 'clip',
        ...
        url: 'https://developer.playcanvas.com/api/pc.CameraComponent.html#farClip'
    }, {
        title: 'nearClip',
        subTitle: '{Number}',
        description: 'The distance in camera space from the camera\'s eye point to the near plane.',
        url: 'https://developer.playcanvas.com/api/pc.CameraComponent.html#nearClip'
    }, {
        title: 'farClip',
        subTitle: '{Number}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.CameraComponent.html#fov'
    }, {
        ...
        url: 'https://developer.playcanvas.com/api/pc.CameraComponent.html#frustumCulling'
    }, {
        title: 'orthoHeight',
        subTitle: '{Number}',
        description: 'The distance in world units between the top and bottom clip planes of an orthographic camera.',
        url: 'https://developer.playcanvas.com/api/pc.CameraComponent.html#orthoHeight'
    }, {
        title: 'priority',
        subTitle: '{Number}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.CameraComponent.html#priority'
    }, {
        title: 'projection',
        subTitle: '{pc.PROJECTION_*}',
        description: 'The projection type of the camera.',
        url: 'https://developer.playcanvas.com/api/pc.CameraComponent.html#projection'
    }, {
        title: 'rect',
        subTitle: '{pc.Vec4}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.CameraComponent.html#rect'
    }, {
        name: 'layers',
        title: 'layers',
        subTitle: '{Number[]}',
        description: 'The layers that this camera will render.',
        url: 'https://developer.playcanvas.com/api/pc.CameraComponent.html#layers'
    }];
