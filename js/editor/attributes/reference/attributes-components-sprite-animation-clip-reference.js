editor.once('load', function () {
    var fields = [{
        ...
        url: 'https://developer.playcanvas.com/api/pc.SpriteAnimationClip.html'
    }, {
        title: 'name',
        subTitle: '{String}',
        description: 'The name of the animation clip. The name of the clip must be unique for this Sprite Component.',
        url: 'https://developer.playcanvas.com/api/pc.SpriteAnimationClip.html#name'
    }, {
        title: 'autoPlay',
        subTitle: '{Boolean}',
        description: 'Enable this if you want to automatically start playing this animation clip as soon as it is loaded.',
        url: 'https://developer.playcanvas.com/api/pc.SpriteAnimationClip.html#autoPlay'
    }, {
        title: 'loop',
        subTitle: '{Boolean}',
        description: 'Enable this if you want to loop the animation clip.',
        url: 'https://developer.playcanvas.com/api/pc.SpriteAnimationClip.html#loop'
    }, {
        title: 'fps',
        subTitle: '{Number}',
        description: 'The number of frames per second to play for this animation clip.',
        url: 'https://developer.playcanvas.com/api/pc.SpriteAnimationClip.html#fps'
    }, {
        title: 'spriteAsset',
        subTitle: '{pc.Asset}',
        description: 'The Sprite Asset that contains all the frames of the animation clip.',
        url: 'https://developer.playcanvas.com/api/pc.SpriteAnimationClip.html#spriteAsset'
    }];
