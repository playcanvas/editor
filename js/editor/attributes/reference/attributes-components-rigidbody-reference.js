editor.once('load', function () {
    var fields = [{
        ...
        url: 'https://developer.playcanvas.com/api/pc.RigidBodyComponent.html'
    }, {
        title: 'linearDamping',
        subTitle: '{Number}',
        description: 'Controls the rate at which a body loses linear velocity over time.',
        url: 'https://developer.playcanvas.com/api/pc.RigidBodyComponent.html#linearDamping'
    }, {
        title: 'angularDamping',
        subTitle: '{Number}',
        description: 'Controls the rate at which a body loses angular velocity over time.',
        url: 'https://developer.playcanvas.com/api/pc.RigidBodyComponent.html#angularDamping'
    }, {
        title: 'angularFactor',
        subTitle: '{pc.Vec3}',
        description: 'Scaling factor for angular movement of the body in each axis.',
        url: 'https://developer.playcanvas.com/api/pc.RigidBodyComponent.html#angularFactor'
    }, {
        title: 'friction',
        subTitle: '{Number}',
        description: 'The friction value used when contacts occur between two bodies.',
        url: 'https://developer.playcanvas.com/api/pc.RigidBodyComponent.html#friction'
    }, {
        title: 'group',
        subTitle: '{Number}',
        description: 'description',
        url: 'https://developer.playcanvas.com/api/pc.RigidBodyComponent.html#group'
    }, {
        title: 'linearFactor',
        subTitle: '{pc.Vec3}',
        description: 'Scaling factor for linear movement of the body in each axis.',
        url: 'https://developer.playcanvas.com/api/pc.RigidBodyComponent.html#linearFactor'
    }, {
        title: 'mass',
        subTitle: '{Number}',
        description: 'The mass of the body.',
        url: 'https://developer.playcanvas.com/api/pc.RigidBodyComponent.html#mass'
    }, {
        title: 'restitution',
        subTitle: '{Number}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.RigidBodyComponent.html#restitution'
    }, {
        title: 'type',
        subTitle: '{pc.RIGIDBODY_TYPE_*}',
        description: 'The type of RigidBody determines how it is simulated.',
        url: 'https://developer.playcanvas.com/api/pc.RigidBodyComponent.html#type'
    }];
