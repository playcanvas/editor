editor.once('load', function () {
    var fields = [{
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html'
    }, {
        title: 'autoPlay',
        subTitle: '{Boolean}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#autoPlay'
    }, {
        title: 'alignToMotion',
        subTitle: '{Boolean}',
        description: 'Orient particle in their direction of motion.',
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#alignToMotion'
    }, {
        title: 'alphaGraph',
        subTitle: '{pc.Curve}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#alphaGraph'
    }, {
        name: 'animTiles',
        title: 'animTilesX / animTilesY',
        subTitle: '{Number}',
        description: 'Number of horizontal / vertical tiles in the sprite sheet',
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#animTilesX'
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#animTilesY'
    }, {
        title: 'animStartFrame',
        subTitle: '{Number}',
        description: 'Sprite sheet frame in animation to begin animating from',
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#animStartFrame'
    }, {
        title: 'animNumFrames',
        subTitle: '{Number}',
        description: 'Number of sprite sheet frames in each animation',
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#animNumFrames'
    }, {
        title: 'animNumAnimations',
        subTitle: '{Number}',
        description: 'Number of animations contained in the sprite sheet',
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#animNumAnimations'
    }, {
        title: 'animIndex',
        subTitle: '{Number}',
        description: 'The animation from the sprite sheet to play for each particle in the system',
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#animIndex'
    }, {
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#randomizeAnimIndex'
    }, {
        title: 'animSpeed',
        subTitle: '{Number}',
        description: 'Sprite sheet animation speed. 1 = particle lifetime, 2 = twice during lifetime etc...',
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#animSpeed'
    }, {
        title: 'animLoop',
        subTitle: '{Boolean}',
        description: 'If true then the sprite sheet animation will repeat indefinitely',
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#animLoop'
    }, {
        title: 'blend',
        subTitle: '{pc.BLEND_*}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#blend'
    }, {
        title: 'colorGraph',
        subTitle: '{pc.CurveSet}',
        description: 'A curve defining how each particle\'s color changes over time.',
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#colorGraph'
    }, {
        title: 'colorMap',
        subTitle: '{pc.Texture}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#colorMap'
    }, {
        title: 'orientation',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#orientation'
    }, {
        title: 'particleNormal',
        subTitle: '{pc.Vec3}',
        description: 'Either world or emitter space vector to define particle plane orientation.',
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#particleNormal'
    }, {
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#depthSoftening'
    }, {
        title: 'depthWrite',
        subTitle: '{Boolean}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#depthWrite'
    }, {
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#emitterExtents'
    }, {
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#emitterRadius'
    }, {
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#emitterShape'
    }, {
        title: 'halfLambert',
        subTitle: '{Boolean}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#halfLambert'
    }, {
        title: 'intensity',
        subTitle: '{Number}',
        description: 'Scales the color of particles to allow them to have arbitrary brightness.',
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#intensity'
    }, {
        title: 'lifetime',
        subTitle: '{Number}',
        description: 'The length of time in seconds between a particle\'s birth and its death.',
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#lifetime'
    }, {
        title: 'lighting',
        subTitle: '{Boolean}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#lighting'
    }, {
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#localVelocityGraph'
    }, {
        title: 'loop',
        subTitle: '{Boolean}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#loop'
    }, {
        title: 'mesh',
        subTitle: '{pc.Asset}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#mesh'
    }, {
        title: 'renderAsset',
        subTitle: '{pc.Asset}',
        description: 'A render asset which can be used instead of the model asset to render a mesh-based particle.',
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#renderAsset'
    }, {
        title: 'normalMap',
        subTitle: '{pc.Texture}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#normalMap'
    }, {
        title: 'numParticles',
        subTitle: '{Number}',
        description: 'The maximum number of particles managed by this particle system.',
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#numParticles'
    }, {
        title: 'paused',
        subTitle: '{Boolean}',
        description: 'Pauses or unpauses the simulation.',
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#paused'
    }, {
        title: 'preWarm',
        subTitle: '{Boolean}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#preWarm'
    }, {
        title: 'rate',
        subTitle: '{Number}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#rate'
    }, {
        title: 'localSpace',
        subTitle: '{Boolean}',
        description: 'Binds particles to emitter node transformation.',
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#localSpace'
    }, {
        title: 'screenSpace',
        subTitle: '{Boolean}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#screenSpace'
    }, {
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#rotationSpeedGraph'
    }, {
        title: 'scaleGraph',
        subTitle: '{pc.Curve}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#scaleGraph'
    }, {
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#radialSpeedGraph'
    }, {
        title: 'sort',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#sort'
    }, {
        title: 'startAngle',
        subTitle: '{Number}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#startAngle'
    }, {
        title: 'stretch',
        subTitle: '{Number}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#stretch'
    }, {
        title: 'velocityGraph',
        subTitle: '{pc.CurveSet}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#velocityGraph'
    }, {
        title: 'wrap',
        subTitle: '{Boolean}',
        description: 'Enables wrap bounds.',
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#wrap'
    }, {
        title: 'wrapBounds',
        subTitle: '{pc.Vec3}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#wrapBounds'
    }, {
        name: 'layers',
        title: 'layers',
        subTitle: '{Number[]}',
        ...
        url: 'https://developer.playcanvas.com/api/pc.ParticleSystemComponent.html#layers'
    }];
